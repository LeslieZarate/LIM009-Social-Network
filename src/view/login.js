import{signInOnSubmit,signInGoogleOnSubmit,signInFacebookOnSubmit } from '../view_controller.js'
export default () => {
		...
		<section class="main m1 h7 p1">
			<article>
				<div class="register-login p2">
					...
					<p>Aun no tines cuenta <span><a href="#/register" id="sing-up">Registrate</a></span></p>				
				</div>
			</article>			
		</section>
	</div>    
   ...
   /*const register = document.querySelector('#sing-up');
